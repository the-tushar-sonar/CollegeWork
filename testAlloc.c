...
char *str alloc(512); char *str2 alloc(512);
...
strcpy(str, "Hello, world!"); if(strcmp("Hello, world!", str)) printf("Hello, world! test failed\n");
...
if(strcmp(stringA, strA) == 0 && strcmp(stringB, strB) == 0 && strcmp(stringC, strC) 0 && strcmp(s

printf("Test 1 passed: allocated 4 chunks of 1KB each\n");

else

printf("Test 1 failed: A: sd, B: %d, C: %d, D: %d\n", strcmp(stringA, strA), strcmp(stringB, strB),
