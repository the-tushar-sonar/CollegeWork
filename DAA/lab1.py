...
def main():
    ...
    while True:
        ...
        print("1. Array 2. SLL 3. DLL 4. Stack 5. Queue 0. Exit")
        ...
        if choice == 1:
            ...
            while True:
                print("STACK: 1. Create 2. Push 3. Pop 4. Search 5. Update 6. Display 0. Back")
                ch = int(input("Choice: "))
                if ch == 0:
                    break
                if ch == 1:
                    ...
                    stack.counter.reset()
                    print("Index:", stack.search(int(input("Value: "))))
                    show_metrics(stack)
                elif ch == 5:
                    stack.update(int(input("Pos: ")), int(input("Value: ")))
                elif ch == 6:
                    stack.display()

        elif choice == 5:
            while True:
                print("QUEUE: 1. Create 2. Enqueue 3. Dequeue 4. Search 5. Update 6. Display 0. Back")
                ch = int(input("Choice: "))
                if ch == 0:
                    break
                if ch == 1:
                    ...
                    queue.counter.reset()
                    print("Index:", queue.search(int(input("Value: "))))
                    show_metrics(queue)
                elif ch == 5:
                    queue.update(int(input("Pos: ")), int(input("Value: ")))
                elif ch == 6:
                    queue.display()
